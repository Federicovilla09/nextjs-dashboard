...
export default function Form() {
  ...
  // Cuando la acción avisa "salió bien", mostramos el toast y recién ahí
  // navegamos a la lista (el Toaster del layout mantiene el toast tras navegar).
  useEffect(() => {
    if (state.success) {
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              name="email"
              type="email"
              placeholder="Ej: evil@rabbit.com"
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
